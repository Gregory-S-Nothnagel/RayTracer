...
int materialAt(Sphere* sphere_list, int num_objects, float* point, int blacklisted_mat, int air_mat) {
...
void func(int WIDTH, int HEIGHT, unsigned char* image_data, float* image_data_float, int frames_still, float* eye_rotation, float* eye_pos, uint32_t* rand_seeds) {
	...
	sycl::buffer<Sphere, 1> sphere_buffer(objects, sycl::range<1>(num_objects));
